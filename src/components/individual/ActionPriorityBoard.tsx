...
const mockActions: Action[] = [
  { 
    id: '1', 
    title: 'Launch "Stein & Dine" Valentine\'s gift card bundle', 
    description: 'Create limited-time gift card bundle (£75 value for £65) with commemorative stein. Birmingham location saw 34% gift card sales increase with similar bundle.',
    priority: 'urgent', 
    timeframe: 'today',
  ...
  { 
    id: '2', 
    title: 'Train staff on experience package upselling', 
    description: 'Implement 15-minute training session on promoting "Bavarian Feast Experience" and bottomless brunch vouchers. Target 20% increase in experience bookings.',
    priority: 'important', 
    timeframe: 'this-week',
    source: 'ai-recommendation',
  ...
  { 
    id: '3', 
    title: 'Optimize digital gift card checkout flow', 
    description: 'Website analytics show 23% abandonment rate at payment stage. Simplify checkout process and add guest checkout option to boost online gift card sales.',
  ...
  { 
    id: '4', 
    title: 'Launch corporate gift card B2B outreach', 
    description: 'Target local businesses for bulk gift card purchases. Create corporate packages with 10% discount for orders over £500. Q4 corporate gifting season approaching.',
    priority: 'opportunity', 
    timeframe: 'next-week',
    source: 'ai-recommendation',
    dataSource: 'historical',
